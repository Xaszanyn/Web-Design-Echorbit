...
function renderProducts() {
  ...
  products.forEach((product) => {
    content += `<button onclick="view(${product.id})"><img src="https://echorbitaudio.com/resources/products/images/${product.image}" /><h6>${product.name}</h6><span>&euro;${product.price}</span><a href="#" onclick="cart(${product.id})">Add to Cart</a></button>`;
  });
