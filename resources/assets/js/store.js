...
async function renderMusics() {
  ...
  musics.forEach((music) => {
    list.innerHTML += `<li><a href="#"><img src="https://www.echorbitaudio.com/resources/musics/images/${music.image}" /></a><div><span>${music.name}</span><span>${music.album}</span></div>
  <audio class="soundwave" controls><source src="https://www.echorbitaudio.com/resources/musics/audios/${music.audio}" type="audio/mp3" /></audio>
