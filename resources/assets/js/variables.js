...
const login = {
  ...
  password: document.querySelector("#login-section .input:nth-of-type(2) input"),
...
const register = {
  ...
  password: document.querySelector("#register-phase .third .input:nth-of-type(1) input"),
  check: document.querySelector("#register-phase .third .input:nth-of-type(2) input"),
